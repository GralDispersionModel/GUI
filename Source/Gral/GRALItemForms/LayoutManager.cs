...
namespace GralItemForms
{
    public partial class Layout : Form
    {
        ...
        public Layout(GralDomain.Domain f)
        {
            ...
            listBox2.DrawItem +=
                 new System.Windows.Forms.DrawItemEventHandler(listBox2_DrawItem);
            listBox3.DrawItem +=
                 new System.Windows.Forms.DrawItemEventHandler(listBox3_DrawItem);
            ...
            listBox3.ItemHeight = listBox3.Font.Height;
        ...
        private void Layout_Load(object sender, EventArgs e)
        {
            ...
            GroupBox r = new GroupBox
            {
                BackColor = Color.Beige,
                Size = new Size(listBox1.Width, listBox1.Font.Height),
                Location = new Point(0, 0)
            };
            listBox1.Controls.Add(r);
            GroupBox r1 = new GroupBox
            {
                BackColor = Color.Beige,
                Size = new Size(listBox2.Width, listBox2.Font.Height),
                Location = new Point(0, 0)
            };
            listBox2.Controls.Add(r1);
            GroupBox r2 = new GroupBox
            {
                BackColor = Color.Beige,
                Size = new Size(listBox3.Width, listBox3.Font.Height),
                Location = new Point(0, 0)
            };
            listBox3.Controls.Add(r2);
            Label l = new Label
            {
                Text = "Values"
            };
            ...
            if (listBox1.Items.Count == 0)
            {
                ...
                for (int i = 0; i < DrawObject.ItemValues.Count; i++)
                {
                    ...
                    {
                    	listBox1.Items.Add(DrawObject.ItemValues[i].ToString());
                    }
                    else
                        listBox1.Items.Add("");
                }
...
//				numericUpDown6.Value = Math.Max(6, Math.Min(12, DrawObject.LabelInterval));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (DrawObject.Name.Substring(0, 3) == "BM:")
                {
                	if (trackBar1.Value < 1) trackBar1.Value = 1; // min opacity
 ...
 //                		domain.picture[_object_index] = SetImageOpacity(domain.picture[_object_index], opacity);
        ...
        {
            e.DrawBackground();
            Brush myBrush = Brushes.Black; myBrush = Brushes.Black;
            try
            {
                ...
                e.Graphics.DrawString(listBox1.Items[e.Index].ToString(), e.Font, myBrush, e.Bounds, drawFormat);	
            }
            catch
            {
            }
        ...
        {
            e.DrawBackground();
            for (int i = 0; i < DrawObject.LineColors.Count; i++)
            {
                SolidBrush myBrush = new SolidBrush(DrawObject.LineColors[i]);
                e.Graphics.DrawLine(new Pen(myBrush, 3), 0, Convert.ToInt32(listBox2.ItemHeight * 0.5,ic) + listBox2.ItemHeight * (i + 1), listBox2.Width, Convert.ToInt32(listBox2.ItemHeight * 0.5,ic) + listBox2.ItemHeight * (i + 1));
            }
        }
        ...
        private void listBox3_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            for (int i = 0; i < DrawObject.FillColors.Count; i++)
            {
                SolidBrush myBrush = new SolidBrush(DrawObject.FillColors[i]);
                e.Graphics.FillRectangle(myBrush, 0, listBox3.ItemHeight*(i+1), listBox3.Width, listBox3.ItemHeight);
            }
        }
        ...
        private void listBox1_DoubleClick(object sender, EventArgs e)
        {
            ...
            string trans = Convert.ToString(listBox1.Items[index],ic);
            if (St_F.InputBoxValue("Change value", "Value:", ref trans, this) == DialogResult.OK)
            {
                try
                {                    
                    double x = Convert.ToDouble(trans);
                    double y;
                    
                    listBox1.Items.Insert(index, Convert.ToString(x));
                    ...
                    for (int i = 1; i < listBox1.Items.Count; i++)
                    {
                        ...
                        {
                            x = Convert.ToDouble(Convert.ToString(listBox1.Items[i]));
                            y = Convert.ToDouble(Convert.ToString(listBox1.Items[j]));
                            if (x > y)
                            {
                                listBox1.Items[i] = listBox1.Items[j];
                                listBox1.Items[j] = Convert.ToString(x);
                            }
                        }
                    }
                    ...
                    for (int i = 1; i < listBox1.Items.Count; i++)
                    	DrawObject.ItemValues.Add(St_F.TxtToDbl(Convert.ToString(listBox1.Items[i]), false));
        ...
        private void listBox2_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (colorDialog1.ShowDialog() == DialogResult.OK)
                    DrawObject.LineColors[listBox2.SelectedIndex - 1] = colorDialog1.Color;
            }
            catch
            {
            }
        ...
        {
            if (colorDialog1.ShowDialog() == DialogResult.OK)
                DrawObject.FillColors[listBox3.SelectedIndex-1] = colorDialog1.Color;
            Refresh();
        }
            ...
            if (init == true)
            {
                ...
                if (DrawObject.Name == "BUILDINGS")
                {
                    ...
                    else
                    {
                        ...
                        if (checkBox5.Checked)
                            listBox1.Items.Insert(1, Convert.ToString(normalize(min)));
                        else
                            listBox1.Items.Insert(1, Convert.ToString(min));

                        listBox2.Items.Insert(1, "");
                        listBox3.Items.Insert(1, "");
                        DrawObject.LineColors.Insert(0, Color.LightGreen);
                        DrawObject.FillColors.Insert(0, Color.LightGreen);

                        if (checkBox5.Checked)
                            listBox1.Items.Add(Convert.ToString(normalize(max)));
                        else
                            listBox1.Items.Add(Convert.ToString(max, ic));
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            listBox1.Items.Insert(2, Convert.ToString(val, ic));
                            listBox2.Items.Insert(2, "");
                            listBox3.Items.Insert(2, "");
                        }
                ...
                if (DrawObject.Name == "VEGETATION")
                {
                    ...
                    else
                    {
                        ...
                        listBox1.Items.Insert(1, Convert.ToString(0));
                        ...
                        listBox1.Items.Add(Convert.ToString(30));
                        ...
                        if ((exist == true) && (comboBox2.SelectedIndex > 0))
                        {
                            ...
                            else
                            {
                                ...
                                if (checkBox5.Checked)
                                	...
                                	listBox1.Items.Insert(1, Convert.ToString(min, ic));
                                listBox2.Items.Insert(1, "");
                                listBox3.Items.Insert(1, "");
                                DrawObject.LineColors.Insert(0, Color.LightGreen);
                                DrawObject.FillColors.Insert(0, Color.LightGreen);
        ...
        {
            string trans="0";
            if (St_F.InputBoxValue("Add value", "Value:", ref trans, this) == DialogResult.OK)
            {
                try
                {
                    double x = Convert.ToDouble(trans);
                    double y;
                    listBox1.Items.Insert(1, Convert.ToString(x));
                    listBox2.Items.Insert(1, "");
                    listBox3.Items.Insert(1, "");
                    DrawObject.FillColors.Insert(0, DrawObject.FillColors[0]);
                    DrawObject.LineColors.Insert(0, DrawObject.LineColors[0]);
        ...
        private void RemoveSelectedLabel(object sender, EventArgs e)
        {
            ...
            index = Math.Max(index, listBox2.SelectedIndex);
            index = Math.Max(index, listBox3.SelectedIndex);
            if((index>0)&&(index<listBox1.Items.Count)&&(listBox1.Items.Count>2))
            {
                listBox1.Items.RemoveAt(index);
                listBox2.Items.RemoveAt(index);
                listBox3.Items.RemoveAt(index);
                DrawObject.ItemValues.RemoveAt(index-1);
                DrawObject.LineColors.RemoveAt(index-1);
                DrawObject.FillColors.RemoveAt(index-1);
            }
        ...
        private void numericUpDown4_ValueChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < DrawObject.ItemValues.Count; i++)
            {
                listBox1.Items.Add(Convert.ToString(Math.Round(Convert.ToDouble(DrawObject.ItemValues[i], ic), Convert.ToInt32(numericUpDown4.Value))));
            }
        }
        ...
        {
            double min = Convert.ToDouble(Convert.ToString(listBox1.Items[1]).Replace(".", decsep));
            double max = Convert.ToDouble(Convert.ToString(listBox1.Items[listBox1.Items.Count-1]).Replace(".", decsep));
            ...
            if (St_F.InputBoxValue("Equidistance", "Value:", ref trans, this) == DialogResult.OK)
            {
                try
                {
                    ...
                    for (int i = 0; i < DrawObject.ItemValues.Count; i++)
                    {
                    	listBox1.Items.Add(St_F.DblToLocTxt(DrawObject.ItemValues[i]));
                        listBox2.Items.Add("");
                        listBox3.Items.Add("");
                    }
