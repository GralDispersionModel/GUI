...
namespace GralDomForms
{
    ...
    public partial class MeteoInput_Matchlocalobs : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            readwindfile.ReadMeteoFiles(1000000, RowSep, DecSep1, DecSepUser, Gral.Main.GUISettings.IgnoreMeteo00Values);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (readwindfile.ReadMeteoFiles(1000000, RowSep, DecSep1, DecSepUser, Gral.Main.GUISettings.IgnoreMeteo00Values) == false)
            {
