...
namespace GralMainForms
{
    ...
    public partial class MeteoInput: Form
	{
		...
		private void Button1_Click(object sender, EventArgs e)
		{
            ...
            readwindfile.ReadMeteoFiles(1000000, RowSep, DecSep1, DecSepUser, Main.GUISettings.IgnoreMeteo00Values);
		...
		private void Button2_Click(object sender, EventArgs e)
		{
            ...
            if (readwindfile.ReadMeteoFiles(1000000, RowSep, DecSep1, DecSepUser, Main.GUISettings.IgnoreMeteo00Values) == false)
			{
