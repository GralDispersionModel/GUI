    ...
    public partial class Emissionvariation : Form
    {
        ...
        private void Panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                e.Graphics.DrawString((div*(i+1)).ToString(), _smallFont,  _blackBrush, Convert.ToInt32(12*pixel), Convert.ToInt32(Convert.ToInt32(280*pixel) - (i + 1) * div * scale), format2);
            }
