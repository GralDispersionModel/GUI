...
namespace Gral
{
    public partial class Main : Form
    {
        ...
        /// </summary>
        public static string CalculationCoresPath = Path.GetDirectoryName(Application.ExecutablePath);
        /// <summary>
        ...
        /// <summary>
        /// Name of high resolution topography file
        /// </summary>
        public static string HR_topofile = string.Empty;
        /// <summary>
        ...
        private void Button8_Click(object sender, EventArgs e)
        {
            ...
            })
            {
                ...
                if (File.Exists(Path.Combine(App_Settings_Path, @"DefaultPath")))
                {
                    try
                    {
                        using (StreamReader read = new StreamReader(Path.Combine(App_Settings_Path, @"DefaultPath")))
                    ...
                    catch
                    {
                        ...
                        MessageBox.Show("Can't open the default path", "GRAL GUI", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
                try
                {
        ...
        private void CreateTextbox1(int y0, int b, int h, int nr)
        {
            ...
            {
                AutoSize = true,
                Font = new System.Drawing.Font("Microsoft Sans Serif", 3.4F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Millimeter, ((byte)(0))),
