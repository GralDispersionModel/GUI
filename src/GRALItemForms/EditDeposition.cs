...
namespace GralItemForms
{
    public partial class EditDeposition : Form
    {
        ...
        void Edit_DepositionLoad(object sender, EventArgs e)
        {
            ...
            string settings = Path.Combine(Main.GUISettings.AppSettingsPath, "DepositionSettings.txt");
        ...
        /// <summary>
        /// If PM10 calculation is disabled, then also disable PMXX calculation
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
