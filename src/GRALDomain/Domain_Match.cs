            ...
            if (MMO.StartMatch) // otherwise cancel matching process
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        MainForm.textBoxMeteoFile.Text = string.Empty;
                        if (Path.GetDirectoryName(metfile).Length > 85)
                        {
                            MainForm.textBoxMeteoFile.Text = metfile.Substring(0, 85) + "...." + Path.DirectorySeparatorChar +
                                    Path.GetFileName(metfile);
                        }
                        else
                        {
                            MainForm.textBoxMeteoFile.Text = metfile;
                        }
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            MainForm.textBoxGrammTerrain.Text = string.Empty;
                            MainForm.textBoxGrammTerrain.Text = MainForm.Topofile;
                        ...
                        if (File.Exists(Path.Combine(Gral.Main.ProjectName, @"Computation", "landuse.asc")))
                        {
                            ...
                            MainForm.textBoxGrammLandUseFile.Text = MainForm.Landusefile;
                        }
