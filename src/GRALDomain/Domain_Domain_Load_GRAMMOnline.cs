...
namespace GralDomain
{
    public partial class Domain
    {
        ...
        public void Domain_Load_GRAMMOnline()
        {
            ...
            if ((MainForm.OnlineParmeters & (1 << 1)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 2)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 16)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 3)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 4)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 5)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 6)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 7)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 8)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 9)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 10)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 11)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 12)) != 0)
            {
            ...
            //start file watcher for latheat_Gramm.txt
            if ((MainForm.OnlineParmeters & (1 << 13)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 14)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 15)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 28)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 17)) != 0)
            {
            ...
            if ((MainForm.OnlineParmeters & (1 << 18)) != 0)
            {
